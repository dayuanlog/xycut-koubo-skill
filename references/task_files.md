...
| `review_state.json` | 审核台人工修改状态，含划线、恢复、分行、素材选择 |
...
## `task_config.json` 关键字段

常用字段：

- `task_dir`
- `paths.final_copy_json`
- `paths.final_copy_txt`
- `paths.materials_dir`
- `paths.material_plan_json`
- `paths.short_subtitles_json`
- `paths.subtitle_layout_plan_json`
- `paths.cover_plan_json`
- `paths.agent_dir`
- `paths.cache_dir`
- `pexels.api_key`
- `pexels.orientation`
- `material_match.orientation`
- `material_match.aspect_ratio`
- `material_match.image_size`
- `material_match.video_size`
- `custom_services`
- `tools.ffmpeg_path`
- `tools.ffprobe_path`
- `tools.sensevoice`
- `optional_ai_services`，仅在用户配置了对应在线服务时出现
